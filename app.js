  ...
  data: {
    ...
    cards: [
      ...
      },
      {
        id: 3,
        condition:
          "Нужно уделить 5 часов на изучение материалов. Изучить или сразу в бой?",
        change: 10000,
        action: 0,
        LastAction: -10000,
        change_peoples: 1,
      ...
      {
        id_V2: 1,
        condition: "Вышестоящий лидер проводит прямой эфир. Пойти на него?",
        img_main: 2,
      },
      {
        id_V2: 2,
      ...
      {
        id_V2: 6,
        condition: "Вам подарили на день рождения 30000 рублей",
        img_main: 4,
        Buttons: false,
      },
      {
      ...
      {
        id_V2: 11,
        condition: "Новый телефон позволил вам быть эффективнее.",
        done: "+5 человек",
        change_peoples: 5,
        action_peoples: 1,
        img_main: 1,
